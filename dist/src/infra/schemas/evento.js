...
export const participanteTimeEventoSchema = new mongoose.Schema({
    ...
    membros_id: [{ type: (Array), ref: 'participante', required: true }],
}, {
    timestamps: true
});
export const eventoSchema = new mongoose.Schema({
    ...
    grupo_id: [{ type: (Array), ref: 'grupo', required: true }],
    final_id: [{ type: (Array), ref: 'final', required: true }],
    repescagem_id: [{ type: (Array), ref: 'repescagem' }],
    evento_tipo: {
